...
export class FiltersComponent implements OnInit {
  ...
  @Output() filtersEvent = new EventEmitter<IFiltersCancel>();
  ...
  filterGroup: IFiltersCancel = new FiltersCancelModel();
  ...
  onFilterClean(){
    ...
    this.filterGroup = new FiltersCancelModel();
  ...
  onFilterUpdate(){
    ...
    const filDefault = new FiltersCancelModel();
